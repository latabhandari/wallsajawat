          ...
          @foreach ($products as $product)
              ...
              <div class="col-sm-3 text-center selling-imgs"> 
                <div class="box-inner">
                 ...
                 <div class="img-price"> <span class="lefttxt"><i class="fa fa-inr"></i>&nbsp;&nbsp;{{ $product->price }} /roll</span> <span class="righttxt"><i class="fa fa-share-alt"></i><a href="javascript:void(0)" id="addwishlist" data-attr="{{ $product->id }}"><i class="fa fa-star"></i></a></span> </div>
               </div>
              </div>
          @endforeach
        @else
