          ...
          @foreach($wishlists as $row)
            ...
            <div class="cart-row">
              <div class="row">
                ...
                <div class="col-sm-4"><a class="remove" onclick="return confirm('are you sure?');" href="{{ route('wishlist.remove', $row->random_string) }}"><button type="button" class="btn btn-danger">Remove</button></a><a href="{{ route('product.detail', $row->slug) }}" title="Product Detail" class="btn pull-left">Detail</a></div>
              </div>
            </div>
