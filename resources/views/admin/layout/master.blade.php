...
<html>
   ...
   <body class="hold-transition skin-blue sidebar-mini">
      ...
      <!-- FastClick -->
      <script src="{{ URL::asset('backend/theme/bower_components/fastclick/lib/fastclick.js') }}"></script>
      <!-- SlimScroll -->
      <script src="{{ URL::asset('backend/theme/bower_components/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
      <!-- AdminLTE App -->
      <script src="{{ URL::asset('backend/theme/dist/js/adminlte.min.js') }}"></script>
      <!-- AdminLTE for demo purposes -->
      <script src="{{ URL::asset('backend/theme/dist/js/demo.js') }}"></script>
