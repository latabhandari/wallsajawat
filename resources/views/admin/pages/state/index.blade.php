            ...
            <div class="box-body">
              ...
              <table id="state" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                     <a class="btn btn-primary" href="{{ route('state.edit',$data->id) }}"><span class="fa fa-edit"></span></a>
                     {!! Form::open(['style' => 'display:inline', 'method' => 'DELETE', 'route' => ['state.destroy', $data->id]]) !!}
