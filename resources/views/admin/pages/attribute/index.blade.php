            ...
            <div class="box-body">
              ...
              <table id="attribute" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                     <a class="btn btn-primary" href="{{ route('attribute.edit',$data->id) }}"><span class="fa fa-edit"></span></a>
                     {!! Form::open(['style' => 'display:inline', 'method' => 'DELETE', 'route' => ['attribute.destroy', $data->id]]) !!}
