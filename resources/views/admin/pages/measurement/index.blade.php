            ...
            <div class="box-body">
              ...
              <table id="category" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                     <a class="btn btn-primary" href="{{ route('measurement.edit',$data->id) }}"><span class="fa fa-edit"></span></a>
                     {!! Form::open(['style' => 'display:inline', 'method' => 'DELETE', 'route' => ['measurement.destroy', $data->id]]) !!}
