                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tbody>
                    ...
                    @foreach ($cart_contents as $content)
	                  <tr>
	                        ...
	                        <tbody>
	                        	<tr>
			                          <td class="mobile-hide-img">
			                            <img width="110" height="92" src="{{ asset('catalog/product/'.$content['image']) }}" alt="item1">
			                          </td>
			                          <td class="product">
	                    ...
	                    <td class="item-col">
	                      <i class="fa fa-inr">&nbsp;</i>{{ $content['price']  * $content['qty'] }}
	                    </td>
			          </tr>
			        @endforeach
                  ...
                  <tr>
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space"><i class="fa fa-inr">&nbsp;</i>{{ $total_amount }}</span> <br>
                      <span class="total-space"><i class="fa fa-inr">&nbsp;</i>{{ $discount }}</span>  <br>
...
<head>
  ...
  <title>Wall Sajawat Invoice</title>
                  ...
                  <tr>
                    <td class="item-col item">
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          <td class="mobile-hide-img">
                            <img width="110" height="92" src="Images/Product6.jpg" alt="item1">
                          </td>
                          <td class="product">
                            <span style="color: #4d4d4d; font-weight:bold;">Ethinic</span> <br />
                            Hot city looks <br/>
							Size : 12x12
                          </td>
                        </tr>
                  ...
                  <tr>
                    <td class="item-col item">
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          <td class="mobile-hide-img">
                            <img width="110" height="92" src="Images/Product5.jpg" alt="item2">
                          </td>
                          <td class="product">
                            <span style="color: #4d4d4d; font-weight: bold;">Classic</span> <br />
                            Newest styles <br/>
							Size : 12x12
                          </td>
                        </tr>
