...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        request()->validate(['categories'  => 'required|array|min:1', 'name' => 'required', 'sku' => 'required', 'stock_item' => 'required|numeric', 'price' => 'required', 'roll_id' => 'required', 'images' => 'required', 'images.*' => 'image|mimes:jpeg,png,jpg,gif,svg']);
    ...
    {
        //
        request()->validate(['categories'  => 'required|array|min:1', 'name' => 'required', 'sku' => 'required', 'stock_item' => 'required|numeric', 'price' => 'required', 'roll_id' => 'required']);
